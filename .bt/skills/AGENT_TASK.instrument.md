...
Read the install guide from the local docs: `/Users/nicolasalvez/ArchivosLocales/SPA/spa/.bt/skills/docs/sdk-install/typescript.md`
...
If the SDK does not print a URL, construct one manually using the URL format documented in `/Users/nicolasalvez/ArchivosLocales/SPA/spa/.bt/skills/docs/sdk-install/braintrust-url-formats.md`:
